...
**入力**: `/specs/001-personal-todo-app/`のデザインドキュメント  
...
4. ブラウザでhttp://localhost:1234が自動的に開くことを確認
...
- [ ] T084 [P] quickstart.mdの検証（手順通りに環境構築できることを確認） in specs/feature/impl-001-personal-todo-app/quickstart.md
