...
1. **仕様を確認**: `specs/001-personal-todo-app/spec.md`を読む
2. **計画を確認**: `specs/feature/impl-001-personal-todo-app/plan.md`を読む
3. **タスクを確認**: `specs/feature/impl-001-personal-todo-app/tasks.md`（Phase 2で生成）
...
```mermaid
flowchart LR
    A[main] --> B[001-personal-todo-app<br/>仕様ブランチ]
    B --> C[feature/impl-001-personal-todo-app<br/>実装ブランチ]
    C -->|Pull Request| B
    B -->|Pull Request| A
```

現在の作業ブランチ: `feature/impl-001-personal-todo-app`
...
- [仕様書](../../001-personal-todo-app/spec.md)
- [実装計画](./plan.md)
- [技術調査](./research.md)
